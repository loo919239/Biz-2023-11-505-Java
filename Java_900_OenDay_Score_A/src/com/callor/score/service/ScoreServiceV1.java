...
public class ScoreServiceV1 {
	 ...
	 * 이때 V1 에 선언된 public method 는 별다른 코드 변경 없이
	 * V2 에서 그대로 사용할 수 있다
	 * 하지만 private 으로 선언된변수는 상속이 안된다
	...
	public void makeScore() {
		...
		/*
		 *  학번을 자동으로 생성하기 
		 *  1. scores 에 초가된 성적표가 있는가 확인
		 *  2. 없으면 최초의 성적이므로 230001 로 학번을 세팅
...
//		}
		...
		for (ScoreDto dto : scores) {
			System.out.printf("%s\t",dto.strNum);
