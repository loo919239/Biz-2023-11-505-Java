...
public class StudentServiceImplV1 implements StudentServiceA{
...
//			e.printStackTrace();
	...
	public void inputStudnet() {
			...
			while(true) {
				...
				StudentDto stdDto = this.searchStudnet(strName);
				if(stdDto == null) {
					Line.dLine(100);
					System.out.println(strName + "자료는 없습니다");
					Line.dLine(100);
				} else {
					this.printStudnet(stdDto);
				}
			}
	 ...
	 * 있으면 학생정보를 StudentDto 에 담에 return
	 * 없으면 null 을 return 
	 */
	@Override
