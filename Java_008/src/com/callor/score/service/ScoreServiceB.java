...
//		String dataFile = "src/com/callor/score/service/data.txt";
		...
		scan = new Scanner(is);
		/*
		 * item(요소) 개수가 0인 상태의 List 가 분비된다
		 */
...
//			System.out.println(line);
	...
	public void printScore() {
		...
		for (int i = 0; i < scores.size(); i++) {
			ScoreDto screDto = scores.get(i); 
			System.out.printf("%s\t",screDto.stdNum);
			
			System.out.printf("%3d\t",screDto.kor);
			System.out.printf("%3d\t",screDto.eng);
			System.out.printf("%3d\t",screDto.math);
			
			System.out.printf("%3d\t",screDto.getTotal());
